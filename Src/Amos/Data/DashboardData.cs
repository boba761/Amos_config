...
{
    [XmlRoot]
    public class DashboardData : ICustomTypeDescriptor//, IData 
    {
        ...
        {
            Directory = new DirectoryInfo( Program.DirectoryDashboard );
            if ( !Directory.Exists )
                Directory.Create();
        }
        ...
        /// <summary>
        /// Возврашает объект директории для хранения настроек объекта
        /// </summary>
        ...
        /// </summary>
        [XmlIgnore]
        public IEnumerable<VariableBase> EnumerableVariables { get { return _variables.Values; } }
        ...
        { 
            get 
            {
                if ( Program.Document.Sequence == null )
                    return null;
                return Program.Document.Sequence.SequenceCollectionVariable;
            } 
        }
        ...
        public CollectionVariable TableCollectionVariable
        {
            get
            {
                if ( Program.Document.Sequence == null )
                    return null;
                return Program.Document.Sequence.TableCollectionVariable;
            }
        }
        ...
        public bool ContainsVariable( string nameVariable )
        {
        ...
        /// </summary>
        public void SetLocalVariables( IList variables )
        {
        ...
        /// </summary>
        public void SetGlobalVariables( IList variables )
        {
        ...
        #region Члены ICustomTypeDescriptor
        ...
        /// <summary>
        /// Возвращает преобразователь типа для этого экземпляра компонента.
        /// </summary>
        ...
        public PropertyDescriptorCollection GetProperties( Attribute[] attributes )
        {
            ...
            foreach ( VariableBase variable in CurrentCollectionVariable.VariableChilds )
            {
                if ( variable is CollectionVariable )
                {
                    foreach ( VariableBase var in (variable as CollectionVariable).VariableChilds )
                        propertyDescriptorCollection.Add( new VariablePropertyDescriptor( var, variable ) );
                }
                else
                    propertyDescriptorCollection.Add( new VariablePropertyDescriptor( variable, null ) );
            }
            if ( Program.Document.Sequence != null )
            {
                foreach ( VariableBase var in SequenceCollectionVariable.VariableChilds )
                    propertyDescriptorCollection.Add( new VariablePropertyDescriptor( var, SequenceCollectionVariable ) );
                foreach ( VariableBase var in TableCollectionVariable.VariableChilds )
                    propertyDescriptorCollection.Add( new VariablePropertyDescriptor( var, TableCollectionVariable ) );
            }
        ...
        /// <summary>
        /// Возвращает объект, содержащий свойства, описанные конкретным дескриптором свойства.
        /// </summary>
