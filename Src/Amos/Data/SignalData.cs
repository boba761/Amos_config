...
namespace Amos.Data
{
    ...
    public class SignalData //: IData
    {
        ...
        { 
            get 
            {
                if ( Program.Document == null || Program.Document.Dashboard.ContainsVariable( "Acq. Points" ) == false )
                    return 1;
                return Convert.ToInt32( Program.Document.Dashboard["Acq. Points"].Value.Data ); 
            } 
        }
        ...
        { 
            get 
            {
                if ( Program.Document == null || Program.Document.Dashboard.ContainsVariable( "Actual Points 2D" ) == false )
                    return 1;
                return Convert.ToInt32( Program.Document.Dashboard["Actual Points 2D"].Value.Data ); 
            } 
        }
        ...
        public int Point3D
        {
            get
            {
                if ( Program.Document == null || Program.Document.Dashboard.ContainsVariable( "Actual Points 3D" ) == false )
                    return 1;
                return Convert.ToInt32( Program.Document.Dashboard["Actual Points 3D"].Value.Data );
            }
        }
        ...
        public int Point4D
        {
            get
            {
                if ( Program.Document == null || Program.Document.Dashboard.ContainsVariable( "Actual Points 4D" ) == false )
                    return 1;
                return Convert.ToInt32( Program.Document.Dashboard["Actual Points 4D"].Value.Data );
            }
        }
        ...
        { 
            get 
            {
                if ( Program.Document == null || Program.Document.Dashboard.ContainsVariable( "Acq. Time" ) == false )
                    return 1;
                return Convert.ToInt32( Program.Document.Dashboard["Acq. Time"].Value.Data ); 
            } 
        }
        ...
        public float[] GetMagnitude( int pos2D, int pos3D, int pos4D )
        {
