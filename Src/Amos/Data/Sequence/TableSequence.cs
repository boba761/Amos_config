...
namespace Amos.Data.Sequence
{
    ...
    public class TableSequence : IObjectSequence
    {
        ...
        /// <summary>
        /// Возвращает объект элемента управления для автоматических таблиц
        /// </summary>
        [XmlIgnore]
        public virtual UserControl AutoControl { get { return null; } }
        ...
        private string GetTitle( IObjectStream @object, string typeTable )
        {
            ...
            {
            case typeTableShape:
                return Program.Document.Sequence.GeneratetNameTable( typeTable, "" );
            case typeTable1D:
                return Program.Document.Sequence.GeneratetNameTable( prefix, "" );
            default:
                return Program.Document.Sequence.GeneratetNameTable( prefix, ":" + typeTable );
            }
        }
    }
}
