...
namespace Data.DataObject.Sequence.Tables
{
    ...
    public class AcquisitionObject : IObjectSequence
    {
        ...
        private string SetVariable( Variable variable, string text )
        {
            if ( _isLinkDashboard )
            {
                variable.SetValue( Document.LoadDocument.Dashboard.Compiler, text );
                Document.LoadDocument.Dashboard.Refresh( );
            }
            else
        ...
        private void ChangeVariables( )
        {
            ...
            if ( _isLinkDashboard )
            {
                _variables.Add( "Points 1D", Document.LoadDocument.Dashboard["Points 1D"] );
                _variables.Add( "Acq. Points", Document.LoadDocument.Dashboard["Acq. Points"] );
                _variables.Add( "SW +/-", Document.LoadDocument.Dashboard["SW +/-"] );
                _variables.Add( "Filter", Document.LoadDocument.Dashboard["Filter"] );
                _variables.Add( "Dwell Time", Document.LoadDocument.Dashboard["Dwell Time"] );
                _variables.Add( "Acq. Time", Document.LoadDocument.Dashboard["Acq. Time"] );
            ...
            {
                _variables.Add( "Points 1D", Document.LoadDocument.Dashboard["Points 1D"] );
                _variables.Add( "Acq. Points", (Variable)Document.LoadDocument.Dashboard["Acq. Points"].Clone( ) );
                _variables.Add( "SW +/-", (Variable)Document.LoadDocument.Dashboard["SW +/-"].Clone( ) );
                _variables.Add( "Filter", (Variable)Document.LoadDocument.Dashboard["Filter"].Clone( ) );
                _variables.Add( "Dwell Time", (Variable)Document.LoadDocument.Dashboard["Dwell Time"].Clone( ) );
                _variables.Add( "Acq. Time", (Variable)Document.LoadDocument.Dashboard["Acq. Time"].Clone( ) );
