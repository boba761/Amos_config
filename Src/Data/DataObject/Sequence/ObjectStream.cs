...
using Data.DataObject.Sequence.Objects;
...
namespace Data.DataObject.Sequence
{
    ...
    [XmlType( "Object" )]
    public abstract class ObjectStream : IObjectStream, IObjectSequence
    {
        ...
        public string VariableName 
        {
            ...
            set { _object = Document.LoadDocument.Sequence.GetSequenceVariable( this, value ); } 
        }
        ...
        public virtual Variable Variable 
        {
            ...
            set 
            {
                _object = Document.LoadDocument.Sequence.CheckVariable( value );
        ...
        public string TableName
        {
            ...
            set 
            {
                _object = Document.LoadDocument.Sequence.GetTable( this, value ); 
            }
        }
        ...
        protected void CloneData( ObjectStream obj )
        {
            obj._type = _type;
            obj._object = (IObjectSequence)_object.Clone();
